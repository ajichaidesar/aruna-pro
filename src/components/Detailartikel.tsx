      ...
      <div>       
        ...
        <div className='xl:p-20 p-5 xl:flex '>
            ...
            <div className='xl:mx-10'>
                <h3 className='xl:text-2xl mt-5  text-xl font-bold'>Artikel Lainnya</h3>
                <p className='xl:text-2xl text-xl my-5'>
                    3 Metode Pembelajaran PAUD dan 
                    Manfaatnya untuk Perkembangan Anak
                </p>
                <hr />
